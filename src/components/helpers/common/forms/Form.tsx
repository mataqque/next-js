...
export const setInputProps = (name: string, classes: string, { values, errors, touched, handleChange, handleBlur }: any) => {
	return {
		name: name,
		value: values[name],
...
export const checkableBoolProps = (name: any, classes = '', { values, errors, touched, handleChange, handleBlur, setFieldValue }: any) => ({
	name: name,
